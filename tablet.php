...
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2016' AND ulkeler.ulke_adi='Almanya'
...
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2017' AND ulkeler.ulke_adi='Almanya'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
  
  $query2 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2018' AND ulkeler.ulke_adi='ALmanya'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
 
  $query3 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2019' AND ulkeler.ulke_adi='ALmanya'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
$query4 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2020' AND ulkeler.ulke_adi='ALmanya'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
	
  $query5 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2016' AND ulkeler.ulke_adi='Hollanda'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
  
  $query6 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2017' AND ulkeler.ulke_adi='Hollanda'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
  
  $query7 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2018' AND ulkeler.ulke_adi='Hollanda'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
 
  $query8 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2019' AND ulkeler.ulke_adi='Hollanda'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
$query9 = $db->query("SELECT urunler.urun_ad as urun, SUM(satis.adet) AS satis_adedi, satis.satis_tarihi , ulkeler.ulke_adi
FROM urunler, satis, urun_turleri, magazalar ,ulkeler
WHERE urun_turleri.urun_tur_id=urunler.urun_tur_id AND urunler.urun_id=satis.urun_id AND satis.magaza_id=magazalar.magaza_id AND magazalar.ulke_id=ulkeler.ulke_id AND urun_turleri.urun_tur_adi='Tablet' and satis.satis_tarihi='2020' AND ulkeler.ulke_adi='Hollanda'
GROUP BY urunler.urun_id
ORDER BY urunler.urun_id");
...
<body>
    ...
    <div class="content">
     ...
     <div class="nav">
     <div>
     <span class="dash">Tablet Satışları</span>
     </div>
     </div>
